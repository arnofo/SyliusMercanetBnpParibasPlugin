 ...
 */
final class MercanetSubscriptionBnpParibasGatewayFactory extends GatewayFactory
{
    public const FACTORY_NAME = 'mercanet_subscription_bnp_paribas';
    ...
    protected function populateConfig(ArrayObject $config)
    {
        $config->defaults([
            ...
            'payum.factory_title' => 'Mercanet Subscription BNP Paribas',
        ...
        if (false == $config['payum.api']) {
            ...
            $config['payum.api'] = function (ArrayObject $config) {
                ...
                $mercanetBnpParibasBridge->setIsRecurringSubscription(true);
